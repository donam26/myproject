...
urlpatterns = [
    ...
    path('admin_dashboard/employees', admin_custom.admin_employee, name='manage_employees'), 
    path('employees/delete/<int:employee_id>/', admin_custom.delete_employee, name='delete_employee'),
